...
# This function helps in generating a list of images for training and validation.
...
# Replace 'FLAGS.image_dir' to '/content/drive/MyDrive/DAEN690/images'
...
#prfx = print (os.path.basename(prfxpath))
